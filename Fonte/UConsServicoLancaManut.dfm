object FConsServicoLancaManut: TFConsServicoLancaManut
  Left = 0
  Top = 0
  ...
  object dbg1: TDBGrid
    ...
    Width = 835
    Height = 403
    DataSource = dsConsServicoLancaManut
  ...
  object dsConsServicoLancaManut: TDataSource
    DataSet = DmFire.ConsServicoLancaManut
    OnDataChange = dsConsServicoLancaManutDataChange
    Left = 368
    Top = 128
  end
