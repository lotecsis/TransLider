object FLogMonitoramentoVeiculos: TFLogMonitoramentoVeiculos
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Log de Monitoramento'
  ClientHeight = 436
  ClientWidth = 994
  Color = clBtnFace
  ...
  object dbg1: TDBGrid
    ...
    Width = 997
    Height = 393
    DataSource = dsConsLogMonitoramento
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'DESVEI'
        Title.Alignment = taCenter
        Title.Caption = 'Desc.Ve'#237'culo'
        Width = 180
        Visible = True
      end
      item
  ...
  object dsConsLogMonitoramento: TDataSource
    DataSet = DmFire.ConsLogMonitoramento
    Left = 224
    Top = 136
  end
end
